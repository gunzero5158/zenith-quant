...
export default function Home() {
  ...
  const fetchActiveStockData = useCallback(async (forceFetch: boolean | React.MouseEvent = false, overrideConfig?: LLMConfig) => {
    ...
    if (!isForce) {
      ...
      if (cachedObj && (
        !isAnalysisCacheVersionCompatible(cachedObj.version) ||
        !isAnalysisCacheLanguageCompatible(cachedObj.language, requestLang)
      )) {
  ...
  }, [activeSymbol, appLanguage, llmConfig, recordAnalysisTimestamp, syncAnalysisQuoteToWatchlist]);
