...
export const TRANSLATIONS: Record<EffectiveLanguage, TranslationStrings> = {
  "zh-CN": {
    ...
    analysisModeLabel: "分析模式", ruleAiMode: "规则评分 + LLM", aiNativeMode: "纯 LLM 分析",
    ...
    jevAiMode: "Jev 决策",
    jevAiSummary: "由 Jev 决策模型对证据逐项做选择题并给出校准概率，大模型只负责依据这些结论撰写报告。",
    jevAiPoint1: "看多看空、左右侧状态、止损止盈均由 Jev 判定",
    jevAiPoint2: "置信度来自校准概率，而非大模型自述",
    jevAiBestFor: "适合：快速判定、概率参考、与其他模式对照",
    jevSectionTitle: "Jev 决策模型（仅「Jev 决策」模式需要）",
    jevSectionDesc: "填写 TypeSafe 官方 API Key。该模式还需要上方的大模型配置来撰写报告。",
    jevApiKeyLabel: "Jev API Key",
    jevBaseUrlLabel: "Jev API 地址（可选）",
    jevModelLabel: "Jev 模型（可选）",
    selectedMode: "当前模式",
    selectMode: "选择此模式",
    objectiveTitle: "统一客观数据底座",
    objectiveDesc: "各分析模式共享真实行情、日周 K 线、EMA、MACD、KDJ、RSI、成交量、支撑压力、形态与结构证据。",
    ...
    guideStep2Desc: "按需求选择规则评分 + LLM、由 LLM 独立判断，或由 Jev 决策模型判定。",
  ...
  "zh-TW": {
    ...
    analysisModeLabel: "分析模式", ruleAiMode: "規則評分 + LLM", aiNativeMode: "純 LLM 分析",
    ...
    jevAiMode: "Jev 決策",
    jevAiSummary: "由 Jev 決策模型對證據逐項做選擇題並給出校準機率，大模型只負責依據這些結論撰寫報告。",
    jevAiPoint1: "看多看空、左右側狀態、止損止盈均由 Jev 判定",
    jevAiPoint2: "置信度來自校準機率，而非大模型自述",
    jevAiBestFor: "適合：快速判定、機率參考、與其他模式對照",
    jevSectionTitle: "Jev 決策模型（僅「Jev 決策」模式需要）",
    jevSectionDesc: "填寫 TypeSafe 官方 API Key。該模式還需要上方的大模型設定來撰寫報告。",
    jevApiKeyLabel: "Jev API Key",
    jevBaseUrlLabel: "Jev API 位址（可選）",
    jevModelLabel: "Jev 模型（可選）",
    selectedMode: "目前模式",
    selectMode: "選擇此模式",
    objectiveTitle: "統一客觀數據底座",
    objectiveDesc: "各分析模式共享真實行情、日週 K 線、EMA、MACD、KDJ、RSI、成交量、支撐壓力、形態與結構證據。",
    ...
    guideStep2Desc: "按需求選擇規則評分 + LLM、由 LLM 獨立判斷，或由 Jev 決策模型判定。",
  ...
  "en": {
    ...
    analysisModeLabel: "Analysis mode", ruleAiMode: "Rules + LLM", aiNativeMode: "LLM Native",
    ...
    jevAiMode: "Jev Decision",
    jevAiSummary: "The Jev decision model answers typed questions about the evidence with calibrated probabilities; the LLM only writes the report around those decisions.",
    jevAiPoint1: "Outlook, setup states, stop and target all decided by Jev",
    jevAiPoint2: "Confidence comes from calibrated probabilities, not LLM self-report",
    jevAiBestFor: "Best for: fast verdicts, probabilities, cross-checking other modes",
    jevSectionTitle: "Jev decision model (only for Jev Decision mode)",
    jevSectionDesc: "Enter an official TypeSafe API key. This mode also needs the LLM settings above to write the report.",
    jevApiKeyLabel: "Jev API Key",
    jevBaseUrlLabel: "Jev API URL (optional)",
    jevModelLabel: "Jev model (optional)",
    selectedMode: "Current mode",
    selectMode: "Select mode",
    objectiveTitle: "One objective data foundation",
    objectiveDesc: "All modes share live quotes, daily and weekly candles, EMA, MACD, KDJ, RSI, volume, levels, patterns, and structural evidence.",
    ...
    guideStep2Desc: "Use Rules + LLM for governed scoring, LLM Native for independent judgment, or Jev Decision for calibrated decisions.",
  ...
  "ja": {
    ...
    analysisModeLabel: "分析モード", ruleAiMode: "ルール + LLM", aiNativeMode: "LLM判断",
    ...
    jevAiMode: "Jev 判定",
    jevAiSummary: "Jev 決定モデルが根拠に対する選択式の質問に較正済み確率で回答し、LLM はその結論に基づいてレポートを書くだけです。",
    jevAiPoint1: "見通し、左右状態、損切り・目標はすべて Jev が判定",
    jevAiPoint2: "確信度は LLM の自己申告ではなく較正済み確率",
    jevAiBestFor: "用途：迅速な判定、確率の参考、他モードとの比較",
    jevSectionTitle: "Jev 決定モデル（Jev 判定モードのみ必要）",
    jevSectionDesc: "TypeSafe 公式の API キーを入力します。このモードではレポート作成のため上の LLM 設定も必要です。",
    jevApiKeyLabel: "Jev APIキー",
    jevBaseUrlLabel: "Jev API URL（任意）",
    jevModelLabel: "Jev モデル（任意）",
    selectedMode: "現在のモード",
    selectMode: "このモードを選択",
    objectiveTitle: "共通の客観データ基盤",
    objectiveDesc: "各モードは実際の株価、日足・週足、EMA、MACD、KDJ、RSI、出来高、支持抵抗、パターン、構造根拠を共有します。",
    ...
    guideStep2Desc: "ルール + LLM、LLM による独自判断、または Jev 決定モデルを選びます。",
