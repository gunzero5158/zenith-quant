...
export const TRANSLATIONS: Record<EffectiveLanguage, TranslationStrings> = {
  "zh-CN": {
    ...
    jevSectionTitle: "Jev 决策模型（仅「Jev 决策 + AI」模式需要）",
    ...
    guideStep2Desc: "按需求选择规则评分 + AI、由 AI 独立判断，或由 Jev 决策模型判定。",
  ...
  "zh-TW": {
    ...
    jevSectionTitle: "Jev 決策模型（僅「Jev 決策 + AI」模式需要）",
    ...
    guideStep2Desc: "按需求選擇規則評分 + AI、由 AI 獨立判斷，或由 Jev 決策模型判定。",
  ...
  "en": {
    ...
    jevSectionTitle: "Jev decision model (only for Jev + AI mode)",
    ...
    guideStep2Desc: "Use Rules + AI for governed scoring, AI Native for independent judgment, or Jev + AI for calibrated decisions.",
  ...
  "ja": {
    ...
    jevSectionTitle: "Jev 決定モデル（Jev + AI モードのみ必要）",
    ...
    guideStep2Desc: "ルール + AI、AI による独自判断、または Jev 決定モデルを選びます。",
